...
#ifndef EBOT_MCU_PREDEF_H_
#define EBOT_MCU_PREDEF_H_
...
// Definitions for ATmega2560 micro-controller on Firebird V robot
	...
	// RGB LED definitions (RGB LED doesn't exist on Firebird V, but added only for simulation of sample projects)
	#define 	rgb_led_ddr_reg					DDRJ
	#define 	rgb_led_port_reg				PORTJ
	#define 	rgb_led_red_pin					1			// PJ1
	#define 	rgb_led_green_pin				5			// PJ5
	#define 	rgb_led_blue_pin				7			// PJ7
	...
	// PWM Timer / Counter registers
	#define		TCCRA_reg						TCCR5A		// Timer / Counter Control Register 5A
	#define		TCCRB_reg						TCCR5B		// Timer / Counter Control Register 5B
	#define		TCCRC_reg						TCCR5C		// Timer / Counter Control Register 5C
	#define		TCNTH_reg						TCNT5H		// Timer / Counter 5 High Byte register
	#define		TCNTL_reg						TCNT5L		// Timer / Counter 5 Low Byte register
	#define		OCRAH_reg						OCR5AH		// Output Compare Register 5 A High Byte
	#define		OCRAL_reg						OCR5AL		// Output Compare Register 5 A Low Byte
	#define		OCRBH_reg						OCR5BH		// Output Compare Register 5 B High Byte
	#define		OCRBL_reg						OCR5BL		// Output Compare Register 5 B Low Byte
	#define		OCRCH_reg						OCR5CH		// Output Compare Register 5 C High Byte
	#define		OCRCL_reg						OCR5CL		// Output Compare Register 5 C Low Byte
	#define		TIMSK_reg						TIMSK5		// Timer / Counter Interrupt Mask register 5
	#define		TIFR_reg						TIFR5		// Timer / Counter Interrupt Flag register 5
...
// Definitions for ATmega328P micro-controller for circuits in SimulIDE software
	...
	// RGB LED definitions (RGB LED doesn't exist on Firebird V, but added only for simulation of sample projects)
	#define 	rgb_led_ddr_reg					DDRD
	#define 	rgb_led_port_reg				PORTD
	#define 	rgb_led_red_pin					4			// PD4	( IO4 )
	#define 	rgb_led_green_pin				5			// PD5	( IO5 )
	#define 	rgb_led_blue_pin				6			// PD6	( IO6 )
	...
	// PWM Timer / Counter registers
	// In the case of the ATmega328P, OCR0 is a 8-bit timer, hence this strategy has been implemented
	#define		OCRAL_reg						OCR0A		// Output Compare Register 0A
	#define		OCRAH_reg						OCR0A		// Output Compare Register 0A
	#define		OCRBL_reg						OCR0B		// Output Compare Register 0B
	#define		OCRBH_reg						OCR0B		// Output Compare Register 0B
	#define		TCCRA_reg						TCCR0A		// Timer / Counter Control Register 0A
	#define		TCCRB_reg						TCCR0B		// Timer / Counter Control Register 0B
	#define		TCNTH_reg						TCNT0		// Timer / Counter 0 register
	#define		TCNTL_reg						TCNT0		// Timer / Counter 0 register
